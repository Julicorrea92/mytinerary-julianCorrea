  ...
  return (
        <header className='flex h-[10vh] items-center px-4 justify-between bg-transparent relative z-10'>
          <nav className='flex  justify-center items-center h-full'>
            ...
            <h1 className='font-semibold sm:text-base md:text-lg lg:text-xl'></h1>
          </nav>
          <div className='flex justify-end'>
            <div className='flex h-10 gap-9 items-center mx-4 py-2 px-4 rounded transition duration-500'>
             {/* Armar componentes para social */}
              <a href="#">
